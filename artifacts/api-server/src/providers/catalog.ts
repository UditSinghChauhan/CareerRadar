...
export const COMPANY_CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    careerUrl: "https://jobs.lever.co/freshworks",
    industry: "SaaS / CRM",
    hiringCategory: "both",
    ...
    note: "Migrated from Greenhouse to Lever. Lever board confirmed 2026-06-27 with 0 active postings. Re-enable when roles are posted.",
  },
  {
    slug: "nutanix",
    name: "Nutanix",
  ...
  },
  {
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Migrated from Lever to Greenhouse. Greenhouse board confirmed 2026-06-27 with 0 active postings. Re-enable when roles are posted.",
  },
  {
    slug: "zepto",
    name: "Zepto",
