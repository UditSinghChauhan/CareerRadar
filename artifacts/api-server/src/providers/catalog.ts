...
export const COMPANY_CATALOG: CatalogEntry[] = [
...

  {
    ...
    note: "India Engineering Hub in Bengaluru. Active fresher + experienced hiring.",
  },
  {
    slug: "adobe",
    name: "Adobe",
    ...
    isActive: true,
    verificationStatus: "verified",
    note: "Noida Research & Engineering center. Hires for Firefly AI and Document Cloud.",
  },
  {
    slug: "postman",
    name: "Postman",
    ...
    note: "Bengaluru HQ. One of India's most prominent API-first SaaS companies.",
  },
  {
    slug: "browserstack",
    name: "BrowserStack",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Mumbai-based global testing infrastructure platform.",
  },
  {
    slug: "thoughtworks",
    name: "ThoughtWorks",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Large annual fresher intake. Offices in Chennai, Bengaluru, Pune, Hyderabad.",
  },
  {
    slug: "freshworks",
    name: "Freshworks",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Chennai HQ. Publicly listed Indian SaaS company with global reach.",
  },
  {
    slug: "nutanix",
    name: "Nutanix",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Bengaluru Engineering and Support center.",
  },
  {
    slug: "rubrik",
    name: "Rubrik",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Palo Alto HQ with Bengaluru engineering center. Cloud data security.",
  },
  {
    slug: "cohesity",
    name: "Cohesity",
...

  {
    ...
    isActive: true,
    verificationStatus: "verified",
    note: "Bengaluru HQ. Full-stack payments platform. Active fresher + experienced hiring.",
  },
  {
    slug: "meesho",
    name: "Meesho",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Bengaluru-based social commerce unicorn. Strong engineering culture.",
  },
  {
    slug: "cred",
    name: "CRED",
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Bengaluru fintech unicorn. Very selective hiring. High compensation.",
  },
  {
    slug: "groww",
    name: "Groww",
  ...
  },
  {
    ...
    isActive: true,
    verificationStatus: "unverified",
    note: "Mumbai-based fantasy sports unicorn. High-scale engineering challenges.",
  },
  {
    slug: "oyo",
    name: "OYO Rooms",
